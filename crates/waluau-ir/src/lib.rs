...
const BIT32_LSHIFT: &str = "bit32.lshift";
const BIT32_RSHIFT: &str = "bit32.rshift";
const BIT32_ARSHIFT: &str = "bit32.arshift";
const BIT32_EXTRACT: &str = "bit32.extract";
const BIT32_REPLACE: &str = "bit32.replace";
const BIT32_BYTESWAP: &str = "bit32.byteswap";
