...
- If PR is behind or conflicted, merge `main` into the branch (never rebase), resolve conflicts, run tests, commit, push, and re-check.
...
- Resolve PR conflicts by merging `main` into the PR branch; do not rebase.
